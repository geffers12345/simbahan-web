<%@ Page Title="Church Announcements" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OrgAnnouncements.aspx.cs" Inherits="SimbahanApp.OrgAnnouncements" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box-body-main" style="background-image: url(Images/Background.jpg); background-repeat: round">
        <div class="row">
            <h2 class="contact-header">ORGANIZATION ANNOUNCEMENTS</h2>
           </div>
        <br />
        <br />
        <div class="row">
                     ...
                     <div class="box">
                            <div class="icon">
                                ...
                                <div class="info">
                                    ...
                                    <p>
                                        <i class="fa fa-envelope" aria-hidden="true"></i>&nbsp organizationinfo@mycatholicportal.org
                                    </p>
