<%@ Page Title="Churches in Quezon City" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Blog-1.aspx.cs" Inherits="SimbahanApp.Blog_1" %>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <h1 class="headerqc" align="center">Top 10 Most Beautiful Churches in Quezon City</h1>
          
          <h3 class ="writer" align="center">By <b>Faye Pascua - </b> April 10, 2017</h3>
          <br/>
          
          <p class="p1"><span style="white-space: nowrap; text-align: center"> Hi Everyone. For those living or for those who wanted to visit the Quezon City Area, here's our list of Beautiful Churches in said area that you might want to visit:
          </span></p>
         ...
         <div class="col-md-12"><br/><br />
          ...
          <div class="col-md-12">
             ...
             <%-- <br />
          <div class="col-md-12">
          	<p class="par2">Those are my list of Churches in Quezon City. Same as that in Manila, below is a map of the Churches listed above to aid your church visits. Click <img src="Images/map button.JPG"/> for the Map Legend. God bless!
          </div>
              <br />
          <div class="col-md-12">
          	<p class="par3">Stay tune for future articles from this site.  Have a meaningful Holy Week.</p>
          </div>--%>
