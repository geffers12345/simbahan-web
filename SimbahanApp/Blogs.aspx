    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <h2 class="my-4">Articles About Faith and Inspirations</h2>

          <!-- Blog Post -->
          <div class="card mb-4">
            <img class="card-img-top" src="Images/20121030-QUEZONCITY-NEX5N-0002.png" alt="Card image cap">
            <div class="card-body">
              <h3 class="card-title">Top 10 Most Beautiful Churches in Quezon City</h3>
              ...
              <a href="Blog-1.aspx" class="btn btn-primary">Read More &rarr;</a>
            </div>
