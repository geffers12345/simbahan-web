...
<div class="tab-pane fade" id="announce">
    ...
    <div id="resultContainer">
        <%--<div class="row church-result">
            ...
            <div class="col-md-8">
                <h4 class="church-name text-danger">MUSIC MINISTRY AUDITIONS</h4>
                <br/>
                <p class="church-location text-muted">8th Note Studio, Jajaj Building, Panay Ave. Quezon City</p>
                <div class="church-details">
                    <br/>
                    <p>
                        Schedule: <strong>February 13, 2017, 7:30 PM – 10:00 PM</strong>
                    </p>
                    <p>The Feast Manila Music Ministry is inviting you to audition! Showcase your talent for the greater glory of God! For those interested, please prepare two songs…</p>
                </div>
            </div>
        </div>--%>
    </div>
